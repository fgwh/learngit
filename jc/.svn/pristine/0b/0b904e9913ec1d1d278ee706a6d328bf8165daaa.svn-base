...
public class BaseAction<T extends BaseEntity>{
	...
	/** 根据登录人员获取中心站 **/
	public List<Org> getCenterList(){
		return OrgUtils.getSubOrgByParentOrgCenterId(operator.getOrg().getId());
	}
	/**  获取所有路段 */
	...
	/**获取轴组的信息*/
	public List<DicItem> getAxisList(){
		return dicService.getItems("axisGroup");
	}
	/**获取拦截选项的信息*/
	public List<DicItem> getOptionList(){
		return dicService.getItems("interceptOption");
	}
	/**获取车型map*/
	...
	/**获取轴组map*/
	public Map<String,String> getAxisMap(){
		return dicService.getItemsMap("axisGroup");
	}
	/**获取拦截选项map*/
	public Map<String,String> getOptionMap(){
		return dicService.getItemsMap("interceptOption");
	}
	/**机构顺序排列*/
	...
	/**获取稽查种类*/
	public List<DicItem> getAbnorTypeList(){
		return dicService.getItems("AbnorType");
	}
	/**获取稽查种类map*/
	public Map<String,String> getAbnorTypeMap(){
		return dicService.getItemsMap("AbnorType");
	}
