...
public class DWRJobForm {
	...
	public void copyFrom(JobDetail jobDetail) throws Exception {
		
		JobDetailImpl jobDetailImpl = (JobDetailImpl)jobDetail;
		this.id = jobDetailImpl.getFullName();
		this.name = jobDetailImpl.getName();
		this.group = jobDetailImpl.getGroup();
		this.description = jobDetailImpl.getDescription();
		this.className = jobDetailImpl.getJobClass().getName();

		//this.volatility = jobDetailImpl.isVolatile();
		this.durability = jobDetailImpl.isDurable();
		this.triggerType = jobDetailImpl.getTriggerType();
	...
	public final void copyFrom(CronTrigger trigger) throws Exception {
		if (trigger != null) {
