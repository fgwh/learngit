...
<body style="height: 900px;">
	<form action="jobTask_save.do" method="post" name="form">
		<ul class="breadcrumb">
			...
			<li>当前位置：${currentPosition}&nbsp;>&nbsp;新增任务</li>
		</ul>
		<div class="widget widget-edit">
			<div class="widget-content">
				<input type="hidden" value="false" name="volatility"> <input
					type="hidden" value="true" name="durability"> <input
						type="hidden" value="false" name="shouldRecover">
				<table id="taskTable" class="pn-ftable table-bordered" border="0" cellpadding="10">
					<tbody>
						<tr>
							<th><span style="color: red;">*</span>任务名称</th>
							<td class="pn-fcontent"><input type="text" name="name"
								id="name" maxlength="200"></td>
							<td class="pn-info"></td>
						</tr>
						<tr>
							<th><span style="color: red;">*</span>任务组</th>
							<td class="pn-fcontent"><input type="text" name="group"
								id="group" maxlength="200"></td>
							<td class="pn-info"></td>
						</tr>
						<tr>
							<th><span style="color: red;">*</span>完整类名</th>
							<td class="pn-fcontent"><input type="text" name="className"
								id="className" maxlength="250" placeholder="包名+类名..."></td>
							<td class="pn-info"></td>
						</tr>
						<tr>
							<th>任务描述</th>
							<td class="pn-fcontent"><textarea rows="3"
									name="description" id="description" maxlength="200" cols="100" onkeypress="lessThan(this)"></textarea>
							</td>
							<td class="pn-info"></td>
						</tr>
						<tr>
							<td colspan="3">
							<a href="#" class=" btn btn-info" id="optionBtn" 
								onclick="javascript:_option();return false;"> 切换表达式 </a>
							</td>
						</tr>
						<tr style="display: none;" id="cronTr">
							<th><span style="color: red;">*</span>cron:</th>
						...
						<tr id="conHelpTr" style="display: none;">
														<th>cron使用说明</th>
														<td class="pn-fcontent"><span style="color: red;">格式: [秒] [分] [小时]
						...
						<tr class="oneTime" style="display: none;">
							...
							<td class="pn-fcontent"><input type="text" name="taskDate"
								id="taskDate" disabled="disabled" class="Wdate" style="background-color:white;" 
						...
						<tr class="oneTime" style="display: none;">
							...
							<td class="pn-fcontent"><input type="text" name="taskTime"
								id="taskTime" disabled="disabled" class="Wdate" style="background-color:white;" 
						...
						<tr class="moreTimeWeek" style="display: none;">
							...
							<td class="pn-fcontent">
								<span>每</span><input value="1" type="text" name="weekTimes" id="weekTimes"
								disabled="disabled" maxlength="3" size="3" style="width: 40px;"
						...
						<tr class="moreTimeMonth" style="display: none;">
							...
							<td class="pn-fcontent">
								<select disabled="disabled" id="monthFrontSel" name="monthFrontSel" style="width: 100px">
									<option value="-1">请选择</option>
								...
								<select disabled="disabled" id="monthBackSel"name="monthBackSel" style="width: 100px">
									<option value="-1">请选择</option>
						...
						<tr class="moreTimeDay" style="display: none;">
							...
							<td class="pn-fcontent">
								<select name="taskRateDaySel"id="taskRateDaySel" disabled="disabled" onchange="rateChangeDay(this)">
									<option value="-1">请选择</option>
						...
						<tr class="moreTimeDay1" style="display: none;">
							...
							<td class="pn-fcontent">
								<span>在每天</span><input type="text" name="oneTime" id="oneTime" disabled="disabled"
								style="width: 80px;background-color:white;" class="Wdate"  
								onClick="javascript:WdatePicker({dateFmt: 'HH:mm:ss',skin:'whyGreen'})"
								readonly="readonly" /><span>执行</span>
							</td>
							<td class="pn-info"></td>
						</tr>
						<tr class="moreTimeDay2" style="display: none;">
							<th><span class="point">*</span>执行间隔为</th>
							<td class="pn-fcontent">
								<span style="float:left">每</span><input type="text" name="betweenTimes" id="betweenTimes" disabled="disabled" style="width: 50px;" onblur="javascript:checkBetweenTimes(this);" />
						...
						<tr class="moreTimeDay3" style="display: none;">
							...
							<td class="pn-fcontent" style="text-align: left;">
								开始日期： <input style="width: 155px; background-color:white;" type="text" name="startTime" id="startTime" disabled="disabled" class="Wdate" onClick="javascript:WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})" readonly="readonly"/>
								<input type="radio"style="margin:0 5px 0 20px;" name="hasEndTime" id="hasEndTime1" value="yes" disabled="disabled" onclick="javascript:checkHasEndTime(this);">
								结束日期： <input onblur="javascript:checkEndTimeValid(this);" style="width: 155px; background-color:white;" type="text" name="endTime" id="endTime" disabled="disabled" class="Wdate" onClick="javascript:WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})" readonly="readonly" /> &nbsp;
								<input type="radio" style="margin:0 5px 0 20px;" name="hasEndTime" id="hasEndTime2" value="no" disabled="disabled" checked="checked" onclick="javascript:checkHasEndTime(this);"> 无结束日期 </td>
							<td class="pn-info"></td>
						</tr>
						<tr>
							<th>任务参数:</th>
							<td class="pn-fcontent">
								<input name="dataKey" type="text" style="width: 130px;"> &nbsp;-&nbsp; 
								<input name="dataValue" type="text" style="width: 350px;">
							</td>
							<td class="pn-info"></td>
						</tr> 
					</tbody>
			...
			<div class="widget-bottom">
					...
					<a href="javascript:history.go(-1);"
						...
						onclick="_submit()" href="javascript:;"
						class="btn btn-primary pull-right">保 存</a>
				</div>
		</div>
	</form>
	<script type="text/javascript">
		var conHelpTr_flag = false;//默认是隐藏
		function _help() {
			conHelpTr_flag = !conHelpTr_flag;
			if (conHelpTr_flag) {
				$("#conHelpTr").show();
			} else {
				$("#conHelpTr").hide();
						...
						if (taskRateVal == "-1") {
							...
							if (taskRateDaySelVal == "-1") {
								...
								//间隔执行
									...
									var betweenTimesVal = $("#betweenTimes")
											.val();
									if (betweenTimesVal == null
											|| betweenTimesVal == "") {
										alert("系统提示：执行间隔不能为空！");
										return false;
									}

									var betweenTimeSelVal = $("#betweenTimeSel")
											.val();
							...
							//每月
								...
								var monthFrontSelVal = $("#monthFrontSel")
										.val();

								var monthBackSelval = $("#monthBackSel").val();

								if (monthFrontSelVal == null
										|| monthFrontSelVal == "") {
									alert("系统提示：请先选择每月执行频率！");
									return false;
								}

								if (monthBackSelval == null
										|| monthBackSelval == "") {
									alert("系统提示：请先选择每月执行频率！");
									return false;
								}
		...
		function _submit() {
			...
			$.ajax({
			   type: "POST",
			   url: "admin/jobTask_nameExist.do",
			   async:false,
			   data: {"jobName":name},
			...
			if (window.confirm("系统提示：确认提交Job？")) {
		...
		function _delete() {
			if (window.confirm("系统提示：确认删除Job？")) {
				document.form.action = "removeQutzJobScheduler.action";
				document.form.submit();
			}
		}
		 ...
		 */
		function _addData() {
			var dataHtml = "<tr><th>任务参数</th><td class='pn-fcontent'><input type='text' name='dataKey' style='width: 130px;'>&nbsp;-&nbsp;<input type='text' name='dataValue' style='width: 350px;'>&nbsp;</td>";
			dataHtml += "<td class='pn-info'><input type='button' style=color:black;margin-buttom:12px;' value=' 删除 ' class='btn'  onclick='onDelete($(this))'/></td></tr>";
			$("#taskTable tr:last").after(dataHtml);
			var frame = $('#rightFrame', parent.document);
