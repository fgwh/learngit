...
public class OperLog  implements BaseEntity {
    ...
    /** full constructor */
    public OperLog(Admin admin, String operType, String moduleId, String details, Date operTime, String ip, String remark,String orgId) {
        this.admin = admin;
