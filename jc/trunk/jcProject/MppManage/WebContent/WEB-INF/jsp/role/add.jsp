...
<script type="text/javascript">
	function check() {
	    ...
	    $.post(
				"role_isExists.do",
				{ "role.name" : name ,"role.type" : roleSelected},
				function(data){
					//console.log(data);
					if(data.name){
						alert(data.name); 
		...
		<div class="widget widget-edit">
			<div class="widget-content">
				<table class="pn-ftable table-bordered" border="0" cellpadding="10">
					<tbody>
						<tr>
							...
							<td class="pn-fcontent"><input type="text" name="role.name" maxlength="50" /></td>
							<td class="pn-info"></td>
						</tr>
						<tr>
						...
						<tr>
							<th>备&nbsp;&nbsp;&nbsp;&nbsp;注</th>
							<td class="pn-fcontent">
							<textarea name="role.remark" rows="3" cols="50" maxlength="100"></textarea>
							</td>
							<td class="pn-info"></td>
						</tr>
						<tr>
				...
				<div class="widget-bottom">
					<a onclick="check()" href="javascript:;" class="btn btn-primary pull-right">保 存</a>
