...
<div id="sidebar">
    <ul>
         ...
         <li class="submenu">
        	<a ><i class="icon icon-dashboard"></i>辅助工具<span class="chevron"><i class="icon-chevron-down"></i></span></a>
            <ul>
            		<li><a href="admin/fileTrans_upLoadList.do" target="mainIframe">文件上传日志查询</a></li>
            		<li><a href="admin/fileTrans_downLoadLogList.do" target="mainIframe">文件下载日志查询</a></li>
                	<li><a href="admin/fileTrans_ftpList.do" target="mainIframe">FTP文件查询</a></li>
                	<li><a href="admin/fileTrans_processData.do" target="mainIframe">文件传输处理</a></li>
                	<li><a href="admin/fileTrans_queryMonitorList.do" target="mainIframe">上传流水监视</a></li>
                	<li><a href="admin/dataBaseCollect_dataBaseSelect.do" target="mainIframe">数据库查询</a></li>
            </ul>
        </li>
    </ul>
</div>
