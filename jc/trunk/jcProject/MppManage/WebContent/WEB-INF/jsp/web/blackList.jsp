            ...
            <table class="pn-ftable" border="0" cellpadding="10">
                ...
                <tr>
                    ...
                    <td class="pn-fcontent">
                        ...
                        <input type="radio" name="fanwei" style="margin-left:20px;" id="luduan"/><label for="luduan">路段</label>
                    </td>
                    <th>车牌号：</th>
        ...
        <div class="widget-content widget-list widget-scroll">  <!--  style="min-height:500px;" -->
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a 	class="btn btn-s-md btn-primary pull-right" data-toggle="modal" data-target="#myModal6" id="">缴费</a>
                    </td>
                    <td>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="pn-fcontent" colspan="5">
                                        <input type="radio" onclick="radioOnclick()" name="addBlack" value="1" style="font-size: 12px;" id="yes"/><label for="yes">是</label>
                                        <input onclick="radioOnclick()" type="radio" name="addBlack" style="margin-left: 20px; font-size: 12px;" value="2"id="no"/><label for="no">否</label>
                                    </td>
                                </tr>
                                <tr>
                                    <th><span>*</span>申请人:</th>
