...
<body>
     <form id="myForm" name="myForm" method="post" action="squad_save.do">
         <ul class="breadcrumb">
			<li><i class="icon-home icon-2x"></i></li>
			<li>当前位置：${currentPosition}&nbsp;>&nbsp;新增工班表信息</li>
		 </ul>
			          ...
			          <tbody>
			        		 <tr>
									<th><span class="point">*</span>工班编号</th>
			                         <td class="pn-fcontent"><input type="text" name="squad.workNo" id="workNo"
			                 ...
			                 <tr>
									<th><span class="point">*</span>工班名称</th>
			                         <td class="pn-fcontent"><input type="text" name="squad.workName" id="workName"
			                 ...
			                 <tr>
			                        ...
			                        <td class="pn-fcontent">
			                        <input type="text" name="squad.startTime" onkeyup="this.value=this.value.replace(/\D/g,'')" style="background-color: white;"
							...
							<tr>
			                        ...
			                        <td class="pn-fcontent">
			                        <input type="text" name="squad.endTime" onkeyup="this.value=this.value.replace(/\D/g,'')" style="background-color: white;"
                            ...
                            <!-- 
			                 <tr>
			                         ...
			                         <td class="pn-fcontent">
			                              ...
			                              <input type ="radio" name ="squad.timeDiff" value ="0" id="enable" checked/>	
			                              <label for="disable">&nbsp;往前一天</label>
			                              <input type ="radio" name ="squad.timeDiff" value ="1" id="disable"/>	  
			                         ...
			                         <th>描述</th>
			                          <td class="pn-fcontent">
										  <input type="hidden" name="squad.timeDiff" value="0"/>
									  	  <textarea id="remark" name="squad.remark" rows="3" cols="50" maxlength="300" onkeyup="limitLength(value,300,'remark');"></textarea>
									  </td>
