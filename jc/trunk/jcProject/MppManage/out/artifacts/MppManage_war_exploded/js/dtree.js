...
,
		//checkbox
		iconUnCheckAll 		: '../images/dtree/checkNone.gif',
		iconCheckAll 		: '../images/dtree/checkAll.gif',
		iconCheckGray 		: '../images/dtree/checkGray.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.setCheck=function(nodeIds){
	var tempIds = this.getNodes(nodeIds);//�õ�Ҷ�ӽڵ�
	var n;
	var len =this.aNodes.length;
	for (n=0; n<len; n++) {
