...
public abstract class AbstractReportAction implements ServletResponseAware, ServletContextAware {
	...
	public Map<String, Object> getParameters() {
		...
		this.parameters.put("vehColorNameMap", getColorMap());
		this.parameters.put("vehClassNameMap", getClassMap());
		this.parameters.put("vehFlagNameMap", getVehFlagNameMap());
		this.parameters.put("interceptOptionNameMap", getOptionMap());
		this.parameters.put("axisMap", getAxisMap());
		return parameters;
	}
	 ...
	 * @return
	 */
	public Map<Short, String> getVehFlagNameMap(){
		Map<Short, String> map = new HashMap<>();
		map.put(Short.parseShort("1"), "客车");
		map.put(Short.parseShort("2"), "货车");
		map.put(Short.parseShort("0"), "非计重或不分客货");
		return map;
	}
