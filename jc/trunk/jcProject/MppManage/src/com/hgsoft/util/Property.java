...
public class Property {
	...
	public static Property likeAnyWhere(String propertyName, String value) {
		return new Property(Restrictions.like(propertyName, value, MatchMode.ANYWHERE));
	}
	...
	public static Property or(Property property1, Property property2) {
		return new Property(Restrictions.or(property1.getCriterion(), property2.getCriterion()));
	}
